...
this is a multiline js commment
it starts with a forward slash,followed by an asterisk 
and it is closed by an asterisk and forward slash
*/
...
const newName = 'Al'; //the preference is we will use single quotes
...
// console.log(prompt('are you 18 or older?'), alert('two nested popups'));

/***** Arithmetic Operators ******/
let total = 1 + 5 + 100;
console.log('my value before increment is: ', total);
++total;
console.log('my new total is: ', total - 10);
